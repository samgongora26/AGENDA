...
function guardar_parcial(){
    ...
    var url = "./modulos/calificaciones/guardar_parcial.php?nombre=" + nombre;
  ...
  function guardar_calificacion(){
    ...
    var url = "./modulos/calificaciones/guardar_calificacion.php?calificacion=" + calificacion+"&"+"materia="+materia+"&"+"parcial="+parcial;
    miPericion4.open("GET", url, true);
  ...
  function editar_calificacion(id){
    ...
    var url = "./modulos/calificaciones/editar_calificacion.php?calificacion="+calificacion+"&"+ "materia=" + materia+ "&"+"parcial="+parcial+"&"+"id="+id;
    miPericion4.open("GET", url, true);
  ...
  function editar_parcial(id){
    ...
    var url = "./modulos/calificaciones/editar_parcial.php?nombre="+nombre+"&"+ "id="+id;
    miPericion4.open("GET", url, true);
    miPericion4.onreadystatechange=respuesta_editar_calificacion;
    miPericion4.send(null);
  }
  ...
  function el_calificacion(id){
    ...
    var url = "./modulos/calificaciones/eliminar_calificacion.php?id="+id;
    miPericion4.open("GET", url, true);
  ...
  function el_parcial(id){
    var id;
    var url = "./modulos/calificaciones/eliminar_parcial.php?id="+id;
    miPericion4.open("GET", url, true);
    miPericion4.onreadystatechange=respuesta_eliminar_calificacion;
    miPericion4.send(null);
  }
